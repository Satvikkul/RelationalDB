...
EfficientMap<Swapify<int>, Swapify<string> > tabNames;
EfficientMap<Swapify<int>, Swapify<int> > tabNumTups;
EfficientMap<Swapify<int>, Swapify<string> > tabPath;
EfficientMap<Swapify<int>, Swapify<int> > tabTID;

EfficientMap<Swapify<int>, Swapify<string> > attNames;
EfficientMap<Swapify<int>, Swapify<int> > attTID;
EfficientMap<Swapify<int>, Swapify<int> > attNumDis;
EfficientMap<Swapify<int>, Swapify<string> > attType;
EfficientMap<Swapify<int>, Swapify<int> > attID;
